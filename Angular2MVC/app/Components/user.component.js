...
var UserComponent = (function () {
    ...
    UserComponent.prototype.LoadUsers = function () {
        ...
        this._userService.get(global_1.Global.BASE_USER_ENDPOINT)
            .subscribe(function (users) { _this.users; _this.indLoading = false; }, function (error) { return _this.msg = error; });
    };
            ...
            case enum_1.DBOperation.create:
                this._userService.post(global_1.Global.BASE_USER_ENDPOINT, formData._value).subscribe(function (data) {
                    if (data == 1) {
                        ...
                        _this.msg = "There is some issue in saving the record, please contact the system administrator!";
                    }
                    _this.modal.dismiss();
                }, function (error) {
                    _this.msg = error;
            ...
            case enum_1.DBOperation.update:
                this._userService.put(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id, formData._value)
                    ...
                    if (data == 1) {
                        ...
                        _this.msg = "There is some issue in updating the record, please contact the system administrator!";
                    }
                    _this.modal.dismiss();
                }, function (error) {
                    _this.msg = error;
            ...
            case enum_1.DBOperation.delete:
                this._userService.delete(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id)
                    ...
                    if (data == 1) {
                        ...
                        _this.msg = "There is some issue in deleting the record, please contact the system administrator!";
                    }
                    _this.modal.dismiss();
                }, function (error) {
                    _this.msg = error;
